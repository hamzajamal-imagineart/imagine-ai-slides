...
function PlusMinus({ open }: { open: boolean }) {
  return (
    <span className="shrink-0 flex items-center justify-center w-8 h-8 rounded-full bg-[rgba(0,34,83,0.05)] text-content-primary">
    ...
    <Reveal delay={delay} className="border-b border-border-primary">
      ...
      >
        <div className="overflow-hidden">
          <p className="font-sans text-[16px] leading-[1.75] text-content-secondary pb-6 max-w-[72ch]">{a}</p>
        </div>
      </div>
    </Reveal>
  );
      ...
      <div className="container-page">
        <div className="py-16 md:py-24 flex flex-col lg:flex-row gap-10 lg:gap-20">
          <Reveal className="lg:w-[360px] shrink-0">
            ...
            >
              Got any questions <span className="text-[rgba(0,34,83,0.35)]">left?</span>
            </h2>
            <p className="font-sans text-[17px] leading-[1.7] text-content-secondary max-w-[36ch] mt-5 tracking-[-0.005em]">
              We&apos;ve answered the questions people ask most about AI Slides.
            </p>
          </Reveal>
